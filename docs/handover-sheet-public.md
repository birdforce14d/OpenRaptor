...
| `NORCA\svc-sp-farm` | SharePoint Farm service account | `Norca@2024!` (permanent — do not rotate) |
| `NORCA\svc-sp-app` | SharePoint App Pool service account | `Norca@2024!` (permanent — do not rotate) |

> All student/admin account credentials will be included in your handover report after deployment.
> Service account passwords (`svc-sp-farm`, `svc-sp-app`) are fixed at `Norca@2024!` — baked into the golden image. Do not rotate.
